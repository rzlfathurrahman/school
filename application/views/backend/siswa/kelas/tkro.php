       ...
       <div class="col-md-12">
         <div class="card card-outline card-info">
           <div class="card-header">
             <h3 class="card-title">
               Data siswa <strong>Teknik Kendaraan Ringan dan Otomotif</strong> SMK MA'ARIF NU 1 AJIBARANG.
             </h3>
             <!-- tools box -->
           ...
           <div class="card-body ">
            ...
            <table id="example2" class="table table-bordered table-striped">
             ...
             <tbody>
             <?php $no = 1; foreach ($tkro as $tkro):?>
               <tr align="center">
                 <td><?= $no++  ?></td>    
                 <td><?= htmlspecialchars($tkro->nis,ENT_QUOTES,'UTF-8');?></td>
                 <td><?= htmlspecialchars($tkro->nama_siswa,ENT_QUOTES,'UTF-8');?></td>
                 <td><?= htmlspecialchars($tkro->kelas,ENT_QUOTES,'UTF-8');?></td>
                 <td>
                   <?php if ($tkro->lulus == 0): ?>
                     <div class="btn btn-sm btn-info">Belum Lulus</div>
                    <?php elseif($tkro->lulus == 1) : ?>
                 ...
                 <td>
                   ...
                   <?= anchor("siswa/hapus_siswa/".$tkro->nis, '<span class="badge badge-pill badge-danger" onclick="return confirm(\' Anda takin ingin menghapus data ini? \')">Hapus</span>') ;?>
