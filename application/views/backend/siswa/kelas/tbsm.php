       ...
       <div class="col-md-12">
         <div class="card card-outline card-info">
           <div class="card-header">
             <h3 class="card-title">
               Data siswa <strong>Teknik dan Bisnis Sepeda Motor</strong> SMK MA'ARIF NU 1 AJIBARANG.
             </h3>
             <!-- tools box -->
           ...
           <div class="card-body ">
            ...
            <table id="example2" class="table table-bordered table-striped">
             ...
             <tbody>
             <?php $no = 1; foreach ($tbsm as $tbsm):?>
               <tr align="center">
                 <td><?= $no++  ?></td>    
                 <td><?= htmlspecialchars($tbsm->nis,ENT_QUOTES,'UTF-8');?></td>
                 <td><?= htmlspecialchars($tbsm->nama_siswa,ENT_QUOTES,'UTF-8');?></td>
                 <td><?= htmlspecialchars($tbsm->kelas,ENT_QUOTES,'UTF-8');?></td>
                 <td>
                   <?php if ($tbsm->lulus == 0): ?>
                     <div class="btn btn-sm btn-info">Belum Lulus</div>
                    <?php elseif($tbsm->lulus == 1) : ?>
                 ...
                 <td>
                   <?= anchor("siswa/detail_siswa/".$tbsm->nis, '<span class="badge badge-pill badge-primary">Detail</span>') ;?>
                   <?= anchor("siswa/edit_siswa/".$tbsm->nis, '<span class="badge badge-pill badge-info">Edit</span>') ;?>
                   <?= anchor("siswa/hapus_siswa/".$tbsm->nis, '<span class="badge badge-pill badge-danger">Hapus</span>') ;?>
