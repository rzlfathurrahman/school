       ...
       <div class="col-md-12">
         <div class="card card-outline card-info">
           <div class="card-header">
             <h3 class="card-title">
               Data siswa <strong>Teknik Audio dan Video</strong> SMK MA'ARIF NU 1 AJIBARANG.
             </h3>
             <!-- tools box -->
           ...
           <div class="card-body ">
            ...
            <table id="example2" class="table table-bordered table-striped">
             ...
             <tbody>
             <?php $no = 1; foreach ($tav as $tav):?>
               <tr align="center">
                 <td><?= $no++  ?></td>    
                 <td><?= htmlspecialchars($tav->nis,ENT_QUOTES,'UTF-8');?></td>
                 <td><?= htmlspecialchars($tav->nama_siswa,ENT_QUOTES,'UTF-8');?></td>
                 <td><?= htmlspecialchars($tav->kelas,ENT_QUOTES,'UTF-8');?></td>
                 <td>
                   <?php if ($tav->lulus == 0): ?>
                     <div class="btn btn-sm btn-info">Belum Lulus</div>
                    <?php elseif($tav->lulus == 1) : ?>
                 ...
                 <td>
                   ...
                   <?= anchor("siswa/edit_siswa/".$tav->nis, '<span class="badge badge-pill badge-info">Edit</span>') ;?>
                   <?= anchor("siswa/hapus_siswa/".$tav->nis, '<span class="badge badge-pill badge-danger">Hapus</span>') ;?>
