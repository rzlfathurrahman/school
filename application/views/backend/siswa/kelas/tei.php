       ...
       <div class="col-md-12">
         <div class="card card-outline card-info">
           <div class="card-header">
             <h3 class="card-title">
               Data siswa <strong>Teknik Elektronika Industri</strong> SMK MA'ARIF NU 1 AJIBARANG.
             </h3>
             <!-- tools box -->
           ...
           <div class="card-body ">
            ...
            <table id="example2" class="table table-bordered table-striped">
             ...
             <tbody>
             <?php $no = 1; foreach ($tei as $tei):?>
               <tr align="center">
                 <td><?= $no++  ?></td>    
                 <td><?= htmlspecialchars($tei->nis,ENT_QUOTES,'UTF-8');?></td>
                 <td><?= htmlspecialchars($tei->nama_siswa,ENT_QUOTES,'UTF-8');?></td>
                 <td><?= htmlspecialchars($tei->kelas,ENT_QUOTES,'UTF-8');?></td>
                 <td>
                   <?php if ($tei->lulus == 0): ?>
                     <div class="btn btn-sm btn-info">Belum Lulus</div>
                    <?php elseif($tei->lulus == 1) : ?>
                 ...
                 <td>
                   <?= anchor("siswa/detail_siswa/".$tei->nis, '<span class="badge badge-pill badge-primary">Detail</span>') ;?>
                   <?= anchor("siswa/edit_siswa/".$tei->nis, '<span class="badge badge-pill badge-info">Edit</span>') ;?>
                   <?= anchor("siswa/hapus_siswa/".$tei->nis, '<span class="badge badge-pill badge-danger">Hapus</span>') ;?>
